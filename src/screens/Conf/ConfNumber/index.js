...
const ConfNumber = ({ navigation }) => (
      <SafeAreaView style={styles.container} behavior="position" enabled>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 0, paddingTop: 0 }}>
          {//<Text style={styles.plus}>+</Text>
          //<TextInput placeholder="DDI" style={styles.DDI} />
          }
          <TextInput keyboardType={'phone-pad'} placeholder="(DDD) 0000 0000" style={styles.DDDNumber} />
        </View>
        <ButtonConfSend style={styles.continueButton} onPress={() => navigation.navigate('ConfirmationCode')}/>
