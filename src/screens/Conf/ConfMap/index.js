...
ConfMap = ({ navigation }) => (
  <SafeAreaView style={{ flex: 1 }}>
    <MapConf/>
    <Card>
      <Card.Title title="Confirme seu endereço" subtitle="Verifique se as informações estão corretas" left={(props) => <Avatar.Icon {...props} icon="map" style={{ backgroundColor: '#ff6400' }} />} />
      <Card.Content>
